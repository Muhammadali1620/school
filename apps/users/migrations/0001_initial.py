    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'admin'), (2, 'teacher'), (3, 'student'), (4, 'perent')])),
                ...
                ('selary', models.DecimalField(decimal_places=2, default=0, help_text='add in UZS', max_digits=20, validators=[django.core.validators.MinValueValidator(0)])),
                ('image', models.ImageField(blank=True, null=True, upload_to='user/student')),
                ...
                ('student_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='students', related_query_name='students', to='groups.studentgroup')),
